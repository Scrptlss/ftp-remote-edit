...
export default class ConfigurationView extends ScrollView {
  ...
  createRequiredDiv() {
    ...
    self.nameInput = new TextEditorView({ mini: true, placeholderText: "Name your Server" });
    ...
    self.hostInput = new TextEditorView({ mini: true, placeholderText: "127.0.0.1" });
